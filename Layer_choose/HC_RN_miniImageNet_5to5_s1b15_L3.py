...
def main():
    ...
    if os.path.exists(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load feature encoder success")
    if os.path.exists(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_network.load_state_dict(torch.load(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load relation network success")
    if os.path.exists(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_coarse_network.load_state_dict(torch.load(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load relation_coarse_network success")
    if os.path.exists(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_Coare_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        Coare_encoder.load_state_dict(torch.load(str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_Coare_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
    ...
    for episode in range(EPISODE):
        ...
        # sample_features = sample_features.cpu().detach().numpy()
        ...
        if (episode+1)%5000 == 0:
            ...
            for test_episode in range(TEST_EPISODE):
                ...
                if test_fine_accuracy > last_accuracy:
                    # save networks
                    torch.save(feature_encoder.state_dict(),str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_network.state_dict(),str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_coarse_network.state_dict(),str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(Coare_encoder.state_dict(),str("./models/HC_RN_miniImageNet_5to5_s1b15_L3_Coare_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
