...
parser.add_argument("-e","--episode",type = int, default= 50000)#500000
...
my_lambda_value = [0,0.15,0.25,0.35,0.45,0.55,0.65,0.75,0.85,0.95]
my_lambda = my_lambda_value[6]
...
def main():
    ...
    if os.path.exists(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load feature encoder success")
    if os.path.exists(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_network.load_state_dict(torch.load(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load relation network success")
    if os.path.exists(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_coarse_network.load_state_dict(torch.load(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load relation_coarse_network success")
    if os.path.exists(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_Coarse_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        Coare_encoder.load_state_dict(torch.load(str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_Coarse_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
    ...
    for episode in range(EPISODE):
        ...
        if (episode+1)%5000 == 0:
            ...
            for test_episode in range(TEST_EPISODE):
                ...
                coarse_batch_label = Variable(torch.zeros(BATCH_NUM_PER_CLASS*CLASS_NUM,cluster_num).scatter_(1, torch.Tensor(test_coarse_labels).long().view(-1,1), 1).cuda(GPU))
                test_coarse_loss = mse(relations,coarse_batch_label)
                #predict labels
                _,predict_coarse_labels = torch.max(relations.data,1)#180  18
                ...
                if test_fine_accuracy > last_accuracy:
                    # save networks
                    torch.save(feature_encoder.state_dict(),str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_network.state_dict(),str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_coarse_network.state_dict(),str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_relation_coarse_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(Coare_encoder.state_dict(),str("./models/HC_RN_lamda_miniImageNet_5to5_s5b10_L2_Coarse_encoder_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
